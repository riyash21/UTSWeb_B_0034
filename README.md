...
- **HTML5**: Menyusun kerangka semantik dari 8 section utama halaman.
- **CSS3**: Kustomisasi palet warna dark-mode pekat dan efek interaktif `:focus` form.
- **Bootstrap 5**: Mengatur layout sistem grid responsif (`.container`, `.row`, `.col-md-*`).
- **JavaScript (Vanilla JS)**: Menangani manipulasi DOM dinamis untuk fitur pengubah tema halaman.
